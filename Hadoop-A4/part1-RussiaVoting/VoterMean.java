 ...
 *  Assignment #4: Question 1 part b
 *  Author: Wen Lin
 *  Prof. Whitney
 */
...
public class VoterMean extends Configured implements Tool {

  private double mean = 0;

  private final static Text COUNT = new Text("count");
  private final static Text PEOPLE = new Text("PEOPLE");
   ...
   */
  public static class VoterMeanMapper extends
    ...
    public void map(Object key, Text value, Context context)
      ...
      context.write(PEOPLE, new LongWritable(voterNum));
   ...
   */
  public static class VoterMeanReducer extends
  ...
  private double readAndCalcMean(Path path, Configuration conf)
    ...
    try {
      ...
      while ((line = br.readLine()) != null) {
        ...
        } else if (type.equals(PEOPLE.toString())) {
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new Configuration(), new VoterMean(), args);
  }
  ...
  public int run(String[] args) throws Exception {
    ...
    Job job = new Job(conf, "voter mean");
    job.setJarByClass(VoterMean.class);
    job.setMapperClass(VoterMeanMapper.class);
    job.setCombinerClass(VoterMeanReducer.class);
    job.setReducerClass(VoterMeanReducer.class);
